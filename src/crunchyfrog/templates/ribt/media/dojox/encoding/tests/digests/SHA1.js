if(!dojo._hasResource["dojox.encoding.tests.digests.SHA1"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.encoding.tests.digests.SHA1"] = true;
