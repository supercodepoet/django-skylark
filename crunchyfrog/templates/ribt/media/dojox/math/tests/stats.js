if(!dojo._hasResource["dojox.math.tests.stats"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.math.tests.stats"] = true;
