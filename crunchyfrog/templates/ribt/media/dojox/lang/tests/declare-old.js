if(!dojo._hasResource["dojox.lang.tests.declare-old"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.lang.tests.declare-old"] = true;
