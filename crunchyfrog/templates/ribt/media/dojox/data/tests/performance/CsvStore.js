if(!dojo._hasResource["dojox.data.tests.performance.CsvStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.data.tests.performance.CsvStore"] = true;
