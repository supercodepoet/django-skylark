if(!dojo._hasResource["dojox.widget.tests.CalendarStackLayout"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.widget.tests.CalendarStackLayout"] = true;
