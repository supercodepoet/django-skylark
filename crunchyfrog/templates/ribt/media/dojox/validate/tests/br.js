if(!dojo._hasResource["dojox.validate.tests.br"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.validate.tests.br"] = true;
