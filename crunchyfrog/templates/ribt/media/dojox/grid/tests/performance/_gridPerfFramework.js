if(!dojo._hasResource["dojox.grid.tests.performance._gridPerfFramework"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.grid.tests.performance._gridPerfFramework"] = true;
